...
[ML-KEM](https://csrc.nist.gov/pubs/fips/203/final), standardized from CRYSTALS-Kyber, is the primary algorithm for general encryption and key establishment. It operates on the polynomial ring **R_q = Z_q[x] / (x^256 + 1)** where q = 3,329, and is based on the hardness of the **Module Learning with Errors (M-LWE)** problem.
